...
C:\vlc-3.0.16-win32.exe /S
C:\npp.8.1.2.Installer.x64.exe /S
C:\WPSOffice_11.2.0.10258.exe /S
C:\womic_driver_setup.exe /S /v"/qn /norestart "
C:\WOMicClientSetupV4.7.exe /S /v"/qn /norestart "
C:\Splashtop_Streamer_Windows_DEPLOY_INSTALLER_v3.exe prevercheck /s /i hidewindow=1,confirm_d=0
